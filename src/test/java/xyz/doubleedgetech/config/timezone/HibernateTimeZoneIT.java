package xyz.doubleedgetech.config.timezone;

import xyz.doubleedgetech.JhipsterApp;
import xyz.doubleedgetech.repository.timezone.DateTimeWrapper;
import xyz.doubleedgetech.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@MicronautTest(application = JhipsterApp.class, environments = {"test"})
